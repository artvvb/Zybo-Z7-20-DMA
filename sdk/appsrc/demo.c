...
int main(void)
{
    ...
    xil_printf("----------------------------------------------------------\r\n");
    xil_printf("BTN0: No effect\r\n");
    xil_printf("BTN1: Record 5 seconds of audio from MIC IN\r\n");
    xil_printf("BTN2: Play back recorded audio on HPH OUT\r\n");
    xil_printf("BTN3: Record 5 seconds of audio from LINE IN\r\n");
    xil_printf("----------------------------------------------------------\r\n");
